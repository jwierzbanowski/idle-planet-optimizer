...
export const SETTINGS_CONFIG = {
  ...
  projects: [
    ...
    { key: 'advancedAlloyValue', label: 'Advanced Alloy Value', desc: 'Alloy value ×1.2', baseEffect: 1.2 },
  ...
  beacon: [
    ...
    { key: 'beacon5_7', label: '5-7', desc: 'Mining rate +2% per level', baseEffect: 1.02, perLevel: 0.02 },
    { key: 'beacon8_10', label: '8-10', desc: 'Mining rate +2% per level', baseEffect: 1.02, perLevel: 0.02 },
    { key: 'beacon11_13', label: '11-13', desc: 'Mining rate +2% per level', baseEffect: 1.02, perLevel: 0.02 },
    { key: 'beacon14_16', label: '14-16', desc: 'Mining rate +2% per level', baseEffect: 1.02, perLevel: 0.02 },
    { key: 'beacon17_19', label: '17-19', desc: 'Mining rate +2% per level', baseEffect: 1.02, perLevel: 0.02 },
    { key: 'beacon20_22', label: '20-22', desc: 'Mining rate +2% per level', baseEffect: 1.02, perLevel: 0.02 },
  ],
  station: [
    ...
    { key: 'alloyItem1', label: 'Alloy & Item 1', desc: 'Alloy & Item value', perLevel: 0.036, maxLevel: 5 },
    { key: 'alloyItem2', label: 'Alloy & Item 2', desc: 'Alloy & Item value', perLevel: 0.08, maxLevel: 5 },
    { key: 'alloyItem3', label: 'Alloy & Item 3', desc: 'Alloy & Item value', perLevel: 0.08, maxLevel: 5 },
    { key: 'alloyItem4', label: 'Alloy & Item 4', desc: 'Alloy & Item value', perLevel: 0.02, maxLevel: 4 },
    { key: 'alloyItem5', label: 'Alloy & Item 5', desc: 'Alloy & Item value', perLevel: 0.02, maxLevel: 4 },
    { key: 'alloyItem6', label: 'Alloy & Item 6', desc: 'Alloy & Item value', perLevel: 0.075, maxLevel: 2 },
    { key: 'alloyItem7', label: 'Alloy & Item 7', desc: 'Alloy & Item value', perLevel: 0.075, maxLevel: 2 },
  ],
  managers: [],
}
