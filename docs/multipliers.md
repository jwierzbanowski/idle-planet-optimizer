...
Factors: **Forge room**, **Furnace projects** (Advanced/Superior Furnace), **Smelting stations** 1–5, **manager skill** (All Smelt Speed), **ships**.
...
Factors: **Workshop room**, **Crafter projects** (Advanced/Superior Crafter), **Crafting stations** 1–5, **manager skill** (All Craft Speed), **ships**.
...
Factors: **Engineering room**, **Mining projects** (Advanced/Superior Mining), **Mining stations** 1–2, **Global 1.2×** station, **ships**.
...
Factors: **Astronomy room**, **Planet Cost stations** 1–5.

### Alloy Value
Value multiplier for alloys.
Factors: **Sales room**, **Alloy & Item stations** 1–7, **Alloy value projects** (Advanced/Superior Alloy Value), **ships**.

### Item Value
Value multiplier for items.
Factors: **Sales room**, **Alloy & Item stations** 1–7, **Item value projects** (Advanced/Superior Item Value), **ships**.

### Manager
Scales all manager effects.
Factors: **Classroom room**, **Manager Training projects** (Manager Training, Advanced Manager Training, Superior Manager Training), **Manager stations** 1–8, **ships**.

### Market Change
Boosts positive market changes set in the Supply & Demand panel.
Factors: **Marketing room**, **Market stations** 1–7.
